...
Select
T2.CustomerCode,T2.BranchCode,T2.CatalogCode,T2.DepositType,T1.AccountNumber,T1.TransactionCode,T3.Description [TransactionDesc],Cast(CreatedOnUtc As date) TransactionDate,Amount,'Card' As Channel From TxnInfo T1 
JOIN AccInfo T2
